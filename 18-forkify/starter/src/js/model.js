...
const createRecipeObject = function (data) {
  ...
  return {
    ...
    // && shortcircuts if recipe.key is empty
    // otherwise an object with key is returned, spread (...) and put into the recipe object
  };
};

// Does not return anything, but updates the state object
